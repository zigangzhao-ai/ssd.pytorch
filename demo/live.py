...
parser.add_argument('--weights', default="/workspace1/zigangzhao/zzg/ssd/weights/ssd_300_VOC0712.pth",
                    type=str, help='Trained state_dict file path')
...
def cv2_demo(net, transform):
    ...
    frame = cv2.imread("/workspace1/zigangzhao/zzg/ssd/000002.jpg")
    frame = predict(frame)
